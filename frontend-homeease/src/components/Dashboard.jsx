const Dashboard = ({ setCurrentView }) => {
  return (
  <div className="container-xl px-4 py-4" style={{ minHeight: '100vh' }}>
      <div className="row mb-4">
        <div className="col-12">
          <h4 className="mb-3 fw-semibold" style={{ fontWeight: 700, fontSize: '1.3rem' }}>TỔNG QUAN</h4>
        </div>
      </div>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              ...
              <h2 className="fw-bold mb-1 text-danger">8</h2>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              ...
              <h2 className="fw-bold mb-1 text-success">42</h2>
              <p className="text-success mb-0 d-flex align-items-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="me-1">
                  <path d="M18 15L12 9L6 15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
